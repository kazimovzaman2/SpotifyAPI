# Generated by Django 4.2.1 on 2023-09-05 02:11

from django.conf import settings
import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import spotify_api.singer.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='song',
            name='audio',
            field=models.FileField(upload_to='song/audio', validators=[django.core.validators.FileExtensionValidator(['mp3', 'wav', 'm4a', 'mp4', 'ogg', 'flac']), spotify_api.singer.validators.validate_file_mimetype]),
        ),
        migrations.AlterField(
            model_name='song',
            name='image',
